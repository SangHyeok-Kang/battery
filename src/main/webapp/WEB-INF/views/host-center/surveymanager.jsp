...
<script type="text/javascript" src="../js/servey.js" ></script>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <button type="button" class="btn btn-outline-info" onclick="<%--여기에 설문지 등록 화면으로 이동--%>">등록 하기</button>
                                ...
                                <div class="row">
                                    <c:forEach var="co" begin="1" end="13">
